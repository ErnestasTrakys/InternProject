		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Vision Board",
									"targetURL": "#visionBoardProjectinternproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"visionBoardProjectinternproject-display": {
								"semanticObject": "visionBoardProjectinternproject",
								"action": "display",
								"description": "visionBoardProject Fiori",
								"title": "Vision Board",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=visionBoardProject.internproject",
									"url": sap.ui.require.toUrl("visionBoardProject/internproject")
								}
							}
						}
					}
